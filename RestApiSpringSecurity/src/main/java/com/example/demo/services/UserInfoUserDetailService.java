 ...
 * 
 * import com.example.demo.config.UserInfoUserDetails; import
 * com.example.demo.entity.UsersInfo; import com.example.demo.repo.UserInfoRepo;
 * 
 * //@Component
 * 
 * @Service public class UserInfoUserDetailService implements UserDetailsService
 * {
 * 
 * @Autowired private UserInfoRepo userInfoRepo;
 * 
 * @Override public UserDetails loadUserByUsername(String name) throws
 * UsernameNotFoundException { Optional<UsersInfo> userInfo =
 * userInfoRepo.findByName(name); return userInfo.map(UserInfoUserDetails::new)
